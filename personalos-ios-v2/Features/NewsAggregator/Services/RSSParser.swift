...
// MARK: - Synchronous Wrapper (Deprecated)

@available(*, deprecated, message: "Use RSSParserActor for async parsing")
class RSSParser: NSObject, XMLParserDelegate {
    ...
    var articles: [(title: String, link: String, description: String, pubDate: String)] = []
